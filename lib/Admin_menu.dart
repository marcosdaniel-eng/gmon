...
class Admin_Menu extends StatefulWidget {
  ...
  @override
  State<Admin_Menu> createState() => _Admin_Menu();
}

class _Admin_Menu extends State<Admin_Menu> {
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(
                          "${saludo["texto"]} $nombreUsuario", // Nombre del administrador con Firestore
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
